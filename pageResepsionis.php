<?php
    ...
    $dtr = new pesan();
    $auth = $dtr->AuthUser("tb_user",$_SESSION['username']);
    $response = $dtr->sessionCheck();
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="pageResepsionis.php?page=cekdta" class="nav-link <?=$activecek?>">
        ...
        <section class="content">
            <div class="container-fluid">
                <?php
                    ...
                    switch ($page){
                        case 'cekdta':
                            include 'page/resepsionis/dataReservasi.php';
                            break;
                        default:
                            $page = "dashboard";
                            include "page/resepsionis/dashboard.php";
                            break;
                    };                
                ?>
            </div>
